...
public class TiotSun5016 {
    ...
    private float ambient_temperature;   //环温
    ...
    private float dew_point;             //露点
    private float ambient_humidity;      //环湿
    private float land_humidity1;        //土湿1
    private float land_humidity2;        //土湿2
    private float land_humidity3;        //土湿3
    private float flow_of_water;          //水势
    private float salinity;             //盐分
    private float water_level;           //水位
    private float co;                   //CO
    ...
    private float average_wind_speed_10;   //10分钟平均风速
    private float cumulative_rainfall_interval;   //雨量间隔累计
    private float daily_cumulative_rainfall;      //雨量日累计
    private float cumulative_sunshine_interval;   //日照间隔累计
    private float daily_cumulative_sunshine;      //日照时日累计
    private float total_radiation;               //总辐射
    private float divergent_radiation;           //散辐射
    private float direct_radiation;              //直辐射
    ...
    public String toString() {
        return "TiotSun5016{" +
                ...
                ", land_humidity1=" + land_humidity1 +
                ", land_humidity2=" + land_humidity2 +
                ", land_humidity3=" + land_humidity3 +
                ", flow_of_water=" + flow_of_water +
                ", salinity=" + salinity +
                ...
                ", average_wind_speed_10=" + average_wind_speed_10 +
                ", cumulative_rainfall_interval=" + cumulative_rainfall_interval +
                ", daily_cumulative_rainfall=" + daily_cumulative_rainfall +
                ", cumulative_sunshine_interval=" + cumulative_sunshine_interval +
                ", daily_cumulative_sunshine=" + daily_cumulative_sunshine +
                ", total_radiation=" + total_radiation +
                ", divergent_radiation=" + divergent_radiation +
